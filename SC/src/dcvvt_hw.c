 ...
 *   Pins 4-7: bits [15:8].  0xFF << 8 = 0xFF00 = four x 0b11.
 */
...
static void gpio_config_af2_pb4_pb7(void)
{
     ...
     * Pins 4-7 occupy MODER bits [15:8] (2 bits x 4 pins).
     * Clear those 8 bits, then OR in 0xAA = 10101010b (four x 0b10).
     */
...
void dcvvt_hw_set_duty(phaser_id_t phaser, float duty_pct)
{
     ...
     * Formula: CCR = duty_pct / 100 x (ARR+1)
     *   -> duty_pct x (ARR+1) x 0.01
     * At 50%: 50 x 8000 x 0.01 = 4000.0 -> CCR=4000 (50.0%) (OK)
     * At 100%: 100 x 8000 x 0.01 = 8000 -> capped to ARR=7999 (99.99%) (OK)
     */
