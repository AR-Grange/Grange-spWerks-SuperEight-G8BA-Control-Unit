 ...
 * --------------------------------------------------------------------------
 *
 *   APB1 timer clock : 200 MHz  (STM32H743, HCLK=400 MHz, APB1 /2 x TMRx2)
 ...
 *     e.g.: 50% -> 50 x 8000 x 0.01 = 4000  ->  4000/8000 = 50.0% (OK)
 *
 *   Special CCR values:
 ...
 *  APB1 timer clock = APB1 x 2 = 200 MHz. */
 ...
 * Corrected: 200 MHz / (100 x 8000) = 250 Hz.
 */
